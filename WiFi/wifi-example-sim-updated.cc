...
int main (int argc, char *argv[]) {
  ...
  string format ("omnet"); //Default as omnet format (changed from db since sqlite is not compiled)
  ...
  **/
  ...
  std::cout << "\n=== Starting Simulation (Duration: " << simTime << " seconds) ===" << std::endl;
  ...
  std::cout << "Saving results to DataOfUser1 files..." << std::endl;
  if (output != nullptr)
  {
